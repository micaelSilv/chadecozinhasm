...
async function getAllGifts() {
    ...
    const { data, error } = await client
        .from("gifts")
        .select("id, category, name, price, detail, purchase_link, image, sort_order, reserved_by_name, reserved_by_phone, confirmed_at")
...
function mapGiftRecord(record) {
    return {
        ...
        purchaseLink: record.purchase_link,
        image: record.image,
...
async function buildSeedRows() {
    ...
    return gifts.map((gift) => ({
        ...
        price: gift.price,
        detail: gift.detail,
        purchase_link: gift.purchaseLink || null,
